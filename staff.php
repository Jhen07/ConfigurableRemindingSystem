...
<body>
	...
	<script type="text/javascript">
		function hello() {
			var r = confirm('Time to take your Medicine!');
			if (r == true) {
		...
		<div class="agile-top">
			...
			<div class="col-xs-2 menu">
				...
				<nav>
					...
					<a href="attend.php">New List Medicine Intake</a>
	...
	<br>
	<h3 class="tittle">
		<span style="color: #0d0550">M</span>edicine <span style="color: #0d0550">M</span>onitoring
	</h3><br>
	<div class="tittle-style"></div>
	<form action="#" method="get">
		<table border="1" cellpadding="10px" width="1118px" cellspacing="50px">
			<thead>
				<tr bgcolor="#0d0550">
					<th><p align="center">NAME</p></th>
					<th><p align="center">MEDICINE</th>
					<th><p align="center">DATE</th>
					<th><p align="center">ASSISTED BY</th>
			...
			<?php
				...
				$sql="SELECT * FROM attendanceform";
				$result = $conn->query($sql);
				if ($result->num_rows > 0) {
					while ($row = $result->fetch_assoc()) {
			...
			<tbody>
				<tr bgcolor="#cfdce5">
					...
					<td><p align="center" style="color: black">
						<?php echo $row["churchid"]; ?>
					 </td>
					 <td><p align="center" style="color: black">
						<?php echo $row["dateattend"]; ?>
					 </td>
					 <td><p align="center" style="color: black">
					 ...
					 <td><p align="center" style="color: black; font-size: 12px">
						<?php echo '<a href="delete.php?bid=' . $row['bid'] . '">Clear </a>' ?>
					 </td>
				</tr>
					<?php
						}
