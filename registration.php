<?php
	...
	if (isset($_POST['submit'])) {		
		if ($_POST['password'] === $_POST['confirm_password']) {
			if($user->register($_POST['firstname'], $_POST['middlename'], $_POST['lastname'], $_POST['dateofbirth'], $_POST['dateofbaptism'], $_POST['locale'], $_POST['churchid'], $_POST['address'], $_POST['contact'], $_POST['emailaddress'], $_POST['username'], $_POST['password'])) {
...
<body>
	...
	<br>
	<h3 class="tittle">
		<span style="color: #0d0550">R</span>egister <span style="color: #0d0550">N</span>ew <span style="color: #0d0550">E</span>lder
	</h3><br>
