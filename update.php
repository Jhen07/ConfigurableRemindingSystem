<?php 
	...
	if (isset($_POST['submit'])) {		
		if ($_POST['password'] === $_POST['confirm_password']) {
			if($user->update($user_id, $_POST['firstname'], $_POST['middlename'], $_POST['lastname'], $_POST['dateofbirth'], $_POST['dateofbaptism'], $_POST['locale'], $_POST['churchid'], $_POST['address'], $_POST['contact'], $_POST['emailaddress'], $_POST['username'], $_POST['password'])) {
				header('Location: index.php');
				exit;
			}
		} else {			
...
<body>
	...
	<br>
	<h3 class="tittle">
		<span style="color: #0d0550">U</span>pdate <span style="color: #0d0550">I</span>nformation
	</h3><br>
			...
			<div class="modal-body modal-body-sub_agile" >
				...
				<form action="#" method="post">
					<div class="styled-input agile-styled-input-top">
						...
						<table>
							<tr>
								...
								<td>
									<input id="middlename" type="text" name="middlename" value="<?php echo $row["middlename"]; ?>" />
								</td>
								<td width="250px">
					...
					<div class="styled-input">
						...
						<input id="dateofbirth" type="text" name="dateofbirth" value="<?php echo  $row["dateofbirth"]; ?>"/>
					</div>
					<div class="styled-input">
						<span>Date of Baptism:</span>
						<input id="dateofbaptism" type="text" name="dateofbaptism" value="<?php echo  $row["dateofbaptism"]; ?>"/>
					</div>
					<div class="styled-input">
						<span>Locale:</span>
						<input id="locale" type="text" name="locale" value="<?php echo $row["locale"]; ?>"/>
					</div>
					<div class="styled-input">
						<span>Church ID:</span>
						<input id="churchid" type="text" name="churchid" value="<?php echo  $row["churchid"]; ?>"/>
					</div>
					<div class="styled-input">
						<span>Address:</span>
					...
					<div class="styled-input">
						...
						<input id="contact" type="text" name="contact" value="<?php echo  $row["contact"]; ?>"/>
					</div>
					<div class="styled-input">
						<span>E-mail Address:</span>
						<input id="emailaddress" type="text" name="emailaddress" value="<?php echo  $row["emailaddress"]; ?>"/>
					</div>
					<div class="styled-input">
						<span>Username:</span>
						<input id="username" type="text"  placeholder=" Username"  name="username" value="<?php echo  $row["username"]; ?>" required/>
					</div>
					<div class="styled-input">
					...
					<div class="styled-input">
						...
						<input style="background: #0d0550" type="submit" name="submit" value="Update">
					<?php
